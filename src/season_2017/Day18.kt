...
//        list = readFile("src/season_2017/input/day18-input-test")
    ...
    fun getRegisterValue(register: String): Long = when (register) {
        "a" -> a
        "b" -> b
        "i" -> i
        "f" -> f
    ...
    fun setRegisterValue(register: String, value: Long) {
        when (register) {
            "a" -> a = value
            "b" -> b = value
            "i" -> i = value
        ...
        loop@ while (true) {
            ...
            when (op.name) {
                "snd" -> {
                    ...
                    lastFrequencyPlayed = getRegisterValue(op.register)
                    opIndex++
                }
                "set" -> {
                    ...
                    if (!op.value.isLetter()) {
                        ...
                        value = getRegisterValue(op.value)
                    }

                    setRegisterValue(op.register, value)
                    opIndex++
                }
                "add" -> {
                    ...
                    if (!op.value.isLetter()) {
                        ...
                        increaseValue = getRegisterValue(op.value)
                    }
                    var currentValue = getRegisterValue(op.register)
                    setRegisterValue(op.register, currentValue + increaseValue)
                    opIndex++
                }
                "mul" -> {
                    ...
                    if (!op.value.isLetter()) {
                        ...
                        multFactor = getRegisterValue(op.value)
                    }
                    val currentValue = getRegisterValue(op.register)
                    setRegisterValue(op.register, currentValue * multFactor)
                    opIndex++
                }
                "mod" -> {
                    ...
                    if (!op.value.isLetter()) {
                        ...
                        moduloValue = getRegisterValue(op.value)
                    }

                    val currentValue = getRegisterValue(op.register)
                    setRegisterValue(op.register, currentValue.rem(moduloValue))
                    opIndex++
                }
                "rcv" -> {
                    ...
                    val regValue = getRegisterValue(op.register)
                ...
                "jgz" -> {
                    ...
                    if (!op.register.isLetter()) {
                        ...
                        regValue = getRegisterValue(op.register)
                    }
