...
class Day06 : BaseDay {
    ...
    /**
     * returns on, off, toggle
     */
    fun getCommand(str: String): String {
        val parsed = str.split(" ")

        if (parsed.size == 5) return parsed[1];

        return "toggle"
    }

    fun turnOnRange(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
    ...
    fun turnOnRangeB(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
    ...
    fun turnOffRange(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
    ...
    fun turnOffRangeB(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
    ...
    fun toggleRange(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
        ...
        for (i in xs..xe) {
            for (j in ys..ye) {
                grid[i][j] = Math.abs(1 - grid[i][j])
            }
        }
    }

    fun toggleRangeB(grid: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>) {
        val xs = start.first
        val ys = start.second
    ...
    fun countOnLights(grid: Array<Array<Int>>): Int {
        var count = 0
    ...
    fun countTotalBrightness(grid: Array<Array<Int>>): Long {
        var brightness = 0L
